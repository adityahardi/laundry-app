...
Route::middleware('auth')->group(function() {
    ...
    Route::middleware('can:admin-kasir')->group(function() {
        ...
        Route::get('transaksi/member/{member}/paket/{paket}/delete', [TransaksiController::class, 'delete'])->name('transaksi.delete');
        Route::get('transaksi/member/{member}/clear', [TransaksiController::class, 'clear'])->name('transaksi.clear');
        Route::post('transaksi/member/{member}', [TransaksiController::class, 'store'])->name('transaksi.store');
